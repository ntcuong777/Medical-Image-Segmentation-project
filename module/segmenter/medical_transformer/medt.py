...
from module.segmenter.medical_transformer.medt_utils import *
...
class medt_net(nn.Module):
    ...
    def _forward_impl(self, x, use_sigmoid=False):
    ...
    def forward(self, x, use_sigmoid=False):
        return self._forward_impl(x, use_sigmoid=use_sigmoid)
