...
if modelname == "axialunet":
    model = medt.axialunet(img_size = imgsize, imgchan = imgchant)
elif modelname == "MedT":
    model = medt.axialnet.MedT(img_size = imgsize, imgchan = imgchant)
elif modelname == "gatedaxialunet":
    model = medt.axialnet.gated(img_size = imgsize, imgchan = imgchant)
elif modelname == "logo":
    model = medt.axialnet.logo(img_size = imgsize, imgchan = imgchant)
